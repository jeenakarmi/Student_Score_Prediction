...
# Set the page layout for the Streamlit app to be wide for better display of UI components
...
# Function to capture user input via interactive widgets
def get_user_input():
     # Create a form in Streamlit for user to enter information
    with st.form(key='my_form'):
         # Use sliders and radio buttons to gather user data
...
if __name__ == "__main__":
    ...
    # Divide the page into three columns for better visual alignment
    ...
    with col2: 
     ...
     # Display the collected user input as a table
    st.write('User Input:')
